...
Modified by Hossein Bagheri to get Latitude and longtitude positions of products
...
FILE_NAME = os.path.join("G:\project\AQ",
                             "data-Iran_Tehran\AOD\AOD19",
                             "MCD19A2.A2019001.h22v05.006.2019009053754.hdf")
...
np.savetxt("lat.txt", lat, fmt="%f")
np.savetxt("lon.txt", lon, fmt="%f")
